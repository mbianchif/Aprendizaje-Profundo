...
\midrule
\multirow{3}{*}{Modelo y Datos} & Dataset & MNIST (Full) \\
...
La configuración de la sección de infraestructura responde al método de serialización de gradientes del sistema, el cual soporta una variante \emph{sparse} (o dispersa). El parámetro $r$ sirve para acotar el sampleo del gradiente que se quiere transmitir: a mayor $r$, mayor será la compresión teórica. 
